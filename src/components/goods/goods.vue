<template>
	<div class="goods">
		<div class="menu-wrapper" ref="menuWrapper">
			<ul>
				<li v-for="(item, index) in goods" class="menu_item border-1px" :class="{'current':currentIndex===index}" @click="selectMenu(index, $event)">
					<span class="text">
		...
		<div class="food-wrapper" ref="foodWrapper">
			<ul>
				<li v-for="item in goods" class="food_list food_list_hook">
					...
					<ul>
						<li v-for="food in item.foods" class="food_item border-1px" @click="selectFood(food, $event)">
							<div class="icon">
